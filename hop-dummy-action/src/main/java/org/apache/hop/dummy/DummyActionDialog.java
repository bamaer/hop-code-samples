...
public class DummyActionDialog extends BaseStepDialog implements StepDialogInterface {

    private static Class<?> PKG = DummyActionDialog.class;

    private DummyActionMeta input;
    ...
    public DummyActionDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        input = (DummyActionMeta) in;
    ...
    public String open() {
        ...
        wlStepname.setText( BaseMessages.getString(PKG, "DummyPluginDialog.ActionName.Label" ) ); //$NON-NLS-1$
        ...
        wlValName.setText( BaseMessages.getString(PKG, "DummyPluginDialog.ValueName.Label" ) ); //$NON-NLS-1$
        ...
        wlValue.setText( BaseMessages.getString(PKG, "DummyPluginDialog.ValueToAdd.Label" ) ); //$NON-NLS-1$
        ...
        wbValue.setText( BaseMessages.getString( "System.Button.Edit" ) ); //$NON-NLS-1$
